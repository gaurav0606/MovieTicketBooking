...
public class ViewMovies extends HttpServlet
{
    public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
    {
        ...
        Connection con=DB_Connection.get_DBConnection();
            ...
            PreparedStatement pst2=con.prepareStatement("select * from movies");
            ...
            if(rs1.next())
            {
                ...
                t=t+"<td><img class='img-thumbnail zoom' src='"+ "GetMovieImage?mcode="+ rs1.getString("mcode")+"' style='width:35px; height:35px;'/>";
